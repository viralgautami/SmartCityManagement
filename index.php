            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="modal" data-target="#exampleModal">Give Problem</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="modal" data-target=".bd-example-modal-lg">Register</a>
                        </li>
                    </ul>
                </div>
            </div>
...
<!--     <li data-target="#carouselExampleIndicators" data-slide-to="0" class="active"></li>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <!-- <form action="contact1.php" method="post" name="contact" onsubmit="return validateForm()"> -->
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form name="login" class="box" onsubmit="return validateForm1()" method="post" action="auth.php">
  <h1>Login</h1>
  <div class="form-group">
 ...
 <center><div class="form-group">
  <input type="submit" class="btn btn-secondary" class="form-control" name="" value="Login">
</div></center>
</form>
                </div>
                ...
                <div class="modal-body">
                    <nav class="ps">
                        ...
                        <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                            <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home"
                                role="tab" aria-controls="nav-home" aria-selected="true">Register As User</a>
                        </div>
                    </nav>
                    <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="nav-home" role="tabpanel"
                            ...
                            <div class="container">
                            <form name="Register" class="box" onsubmit="return validateForm3()" method="post" action="AddUser.php">
  <h1>Register</h1>
  <div class="form-group">
  <input type="text" id="uname3" class="form-control"  placeholder="Username" name="uname" >
</div>
  <div class="form-group">
  <input type="text" id="email3" class="form-control" placeholder="Enter Email" name="email" >
</div>
<div class="form-group">
  <input type="password" id="psw3" class="form-control" placeholder="Password" name="psw">
</div>
<div class="form-group">
  <input type="password" id="cpsw3" class="form-control" placeholder="Confirm Password" name="cpsw">
</div>

<center><div class="form-group">
  <input type="submit" class="btn btn-secondary" id=""   value="Register" name="">
</div></center>
</form>
                            </div>
                        </div>
...
function validateForm3() {
    ...
    var username = document.getElementById("uname3").value;
    var uemail = document.getElementById("email3").value;
    var password = document.getElementById("psw3").value;
       var cpassword = document.getElementById("cpsw3").value;
    ...
    if (!un.test(username)) {
        alert("username must be filled out");
        return false;
    } else if(!ue.test(uemail)){
    alert("enter valid email id");
        return false;
    } else if(!up.test(password)){
    alert("Password must be contain length of 8,capital latter,small latter,numbers and spacial character");
        return false;
    } else if(cpassword != password){
    alert("Password doesn't metch");
        return false;
